...
PSSP_protoDialog::PSSP_protoDialog(wxWindow* parent,wxWindowID id)
{
    ...
    Create(parent, wxID_ANY, _("PSSP-proto"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE, _T("wxID_ANY"));
    BoxSizer1 = new wxBoxSizer(wxHORIZONTAL);
    StaticText1 = new wxStaticText(this, ID_STATICTEXT1, _("Welcome to\nPSSP-proto"), wxDefaultPosition, wxDefaultSize, 0, _T("ID_STATICTEXT1"));
...
void PSSP_protoDialog::OnAbout(wxCommandEvent& event)
{
    ...
    msg.append("\nPSSP-proto is used to generate settings for PSSPcc.");
